  ...
  if (!friend) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <button
          onClick={() => navigate("/")}
          className="bg-[#234e44] text-white px-6 py-2 rounded-md"
        >
          Back to Home
        </button>
      </div>
        ...
        <aside className="space-y-6">
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center">
            ...
            <div className="flex flex-col items-center gap-2 mb-4">
              <span
                className={`text-[10px] font-bold uppercase tracking-widest px-4 py-1 rounded-full ${
                  friend.status === "overdue"
                    ? "bg-red-500 text-white"
                    : friend.status === "almost due"
                    ? "bg-orange-400 text-white"
                    : "bg-[#234e44] text-white"
                }`}
              >
                {friend.status}
              </span>
            ...
            <p className="text-slate-600 text-sm italic mb-1 leading-relaxed">
              "{friend.bio}"
            </p>
          ...
          <div className="space-y-3">
            ...
            <button className="w-full bg-white text-red-500 py-3 rounded-xl border border-gray-100 shadow-sm font-bold flex items-center justify-center gap-3 hover:bg-red-50 transition-all hover:text-white">
        ...
        <main className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
              <h2 className="text-3xl font-black text-[#234e44] mb-3">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center flex flex-col justify-center">
              <h2 className="text-2xl font-black text-[#234e44] uppercase mb-3">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
            ...
            <button className="bg-slate-50 p-2.5 rounded-lg border border-gray-200 hover:bg-slate-100 text-gray-600 flex items-center gap-2">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <button className="bg-white py-8 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center gap-3 hover:bg-gray-50 transition-all border-b-4 border-b-slate-100">
